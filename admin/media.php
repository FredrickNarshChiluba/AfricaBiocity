  ...
  background-size: cover;" >
    <div class="container">
      <div class="intro-text">
        ...
        <h3>Add Media Images and Description</h3>
        <form class="pt-2" method="POST" action="./process.php" enctype="multipart/form-data">
          <div class="form-group">
              <input type="file" name="medImg" style="width:400px;" required>
          </div>
          <div class="form-group">
              <textarea name="medDescription" placeholder="Enter Media description" style="height: 100px;width: 400px;" required>
                
              </textarea>
          </div>
          <div class="form-group">
            <input class="btn btn-sm btn-info" type="submit" name="media" value="Submit Media">
          </div>
