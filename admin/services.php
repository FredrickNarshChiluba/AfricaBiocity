      ...
      <div class="intro-text">
        ...
        <form class="pt-2" method="POST" action="./process.php">
          <div class="form-group">
              <select name="serviceVal" style="width:400px;">
                <option value="" selected disabled required>Select Service</option>
                <option value="Public health program management">Public health program management</option>
                <option value="Health sector consultancies">Health sector consultancies</option>
                <option value="Setting up laboratory system/service">Setting up laboratory system/service</option>
              </select>
          </div>
          <div class="form-group">
              <textarea name="description" placeholder="Enter service description" style="height: 100px;width: 400px;">
                
              </textarea>
          </div>
          <div class="form-group">
            <input class="btn btn-sm btn-info" type="submit" name="service" value="Submit Service">
          </div>
