  ...
  background-size: cover;" >
    <div class="container">
      <div class="intro-text">
        ...
        <form method="POST" action="./process.php" class="pt-2">
          <div class="form-group">
              <textarea name="aboutVal" placeholder="Enter details about Africa Biocity" style="height: 100px;width: 400px;">
                
              </textarea>
          </div>
          <div class="form-group">
            <input class="btn btn-sm btn-info" type="submit" name="about" value="Submit About">
          </div>
